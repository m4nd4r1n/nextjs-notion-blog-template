...
export const ThemeSwitchSkeleton: FC<ThemeSwitchSkeletonProps> = (props) => {
  return (
    <I18nProviderClient>
      <ThemeSwitchSkeletonImpl {...props} />
    </I18nProviderClient>
  );
};

const ThemeSwitchSkeletonImpl: FC<ThemeSwitchSkeletonProps> = ({
  dark,
  onChange,
}) => {
